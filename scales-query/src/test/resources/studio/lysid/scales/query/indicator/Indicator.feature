Feature: The Indicator aggregate
  ...
  Scenario Outline: An Indicator can only be published when in Draft state
    ...
    When I publish this Indicator
    Then it should throw an IllegalStateException with message "An indicator can be published only when it has a Draft status."
  ...
  Scenario: An Archived Indicator cannot be archived again
    ...
    When I archive this Indicator
    Then it should throw an IllegalStateException with message "An indicator can be archived only when it has a Draft, Published or Evolved status."
  ...
  Scenario: An Indicator cannot be archived if one of its using scales is not archived
    ...
    When I archive this Indicator
    Then it should throw an IllegalStateException with message "An indicator can be archived only if no Scale is using it or if all Scales using it are also archived."
  ...
  Scenario Outline: Only Archived Indicator can be unarchived
    ...
    When I unarchive this Indicator
    Then it should throw an IllegalStateException with message "An indicator can be unarchived only when it has an Archived status."
